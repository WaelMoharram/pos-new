...
@section('content_header')
    <h1>تعديل فاتورة مرتجع توريد رقم {{$bill->code}}</h1>
@stop
...
@section('content')
    ...
    <div class="card col-md-12 {{--collapsed-card--}}">
        ...
        <div class="card-body p-0">
            ...
            @csrf()
            <div class="row">
                @include('dashboard.bills.purchase_out._form')
...
<div class="row ">
    ...
    @include('dashboard.bills.purchase_out._table_details')
<div class="col-md-6 ">
    <div class="card ">
        <div class="card-header">
        ...
        <div class="card-body p-0">
            {{-- ########## Add item Form  ########## --}}
                ...
                {!! Form::open(['method'=>'post','route'=>'bill-details.store','class'=>' col-md-12','dir'=>'']) !!}
                    @csrf()
                    <div class="row">
                        @include('dashboard.bills.purchase_out._form_details')
                    </div>
                {!! Form::close() !!}
        </div>
    </div>
