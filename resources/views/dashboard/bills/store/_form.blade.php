...
<div class="form-group py-1 col-md-6">
    ...
    {{Form::select('store_from_id',\App\Models\Store::get()->pluck('select_name','id') ,null,['disabled','class'=>'form-control mb-2','id'=>'store_from_id'])}}
    {{input_error($errors,'store_from_id')}}
</div>
{{-- ############# Store #############--}}
<div class="form-group py-1 col-md-6">
    <label for="store_id"> مخزن الاستلام  </label>
    {{Form::select('store_to_id',\App\Models\Store::get()->pluck('select_name','id') ,null,['disabled','class'=>'form-control mb-2','id'=>'store_to_id'])}}
